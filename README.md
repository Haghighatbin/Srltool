...
# tree --> Lists the content of the specified directory in a Tree format.
Examples:
srltool tree
or 
srltool tree [folder]
...
# stat_flash --> Returns details of the allocated and available flash space.

Example:
srltool stat_flash
srltool stat_flash --help

# stats --> Returns the overall flash size details and memory stauts.
...
# rmfile --> Removes the specified file without further notice, please be cautious!
...
# sendfile -->  Sends the specified file [filename_to_send] and will save as the specified file [filename_to_save].
# If the [filename_to_save] has not been specified as an argument, 
# then the same name as the [filename_to_get] will be designated to save the # file.
...
# senddir --> Sends the specified directory [dirname_to_send] and all its included files to the specifieddirectory [dirname_to_save].
# If the [dirname_to_save] has not been specified as an argument, 
# then the same name as the [dirname_to_send] will be designated to save the folder. 
...
# recvfile --> (self, filename_to_get: str, filename_to_save: str=None, check_exist: bool=True, BUFFER_SIZE: int=32) -> None:
...
# recvdir --> recvdir(self, dirname_to_get:  str, dirname_to_save: str=None) -> None:
...
# If the [dirname_to_save] has not been specified as an argument, 
# then the same name as the [dirname_to_get] will be designated to save the folder. 
...
# astroid --> Requests a list of coordinates and will plot an astroid as a serial test.
